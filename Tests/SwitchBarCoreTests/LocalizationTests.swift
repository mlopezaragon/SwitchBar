...
private func localizationCatalog(
    ...
    let url = projectRoot
        .appendingPathComponent("Sources/SwitchBarCore/Resources")
...
@Test func todasLasClavesUsadasExistenEnTodosLosIdiomas() throws {
    let reference = try localizationCatalog("en")
    let sources = [
        projectRoot.appendingPathComponent("Sources/SwitchBar"),
        projectRoot.appendingPathComponent("Sources/SwitchBarCore")
